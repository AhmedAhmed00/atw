  ...
  return (
    <div className="flex flex-col bg-card text-card-foreground">
      <button
        type="button"
        onClick={handleClick}
        className="w-full rounded-t-lg border bg-card px-3 py-2 text-sm font-semibold hover:bg-accent focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
      >
        {monthName}
      </button>

      <div className="flex-1 space-y-2 rounded-b-lg border border-t-0 bg-card p-3">
