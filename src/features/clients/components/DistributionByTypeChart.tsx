...
import { DistributionByType } from '../data/mockInstitutionsData'

interface DistributionByTypeChartProps {
  data: DistributionByType[]
}

export function DistributionByTypeChart({ data }: DistributionByTypeChartProps) {
  return (
    <Card className="border-t-4 border-t-[#09B0B6]">
      <CardHeader>
        ...
        <CardDescription className="text-xs md:text-sm">
          Institutions categorized by type
        </CardDescription>
      </CardHeader>
      <CardContent>
