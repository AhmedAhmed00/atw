...
export type VehicleViewMode = 'table' | 'map'

interface VehicleViewToggleProps {
  value: VehicleViewMode
  onChange: (mode: VehicleViewMode) => void
  className?: string
}

export function VehicleViewToggle({ value, onChange, className }: VehicleViewToggleProps) {
  return (
